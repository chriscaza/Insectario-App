    ...
    const animatedStyles = {
        ...
        clearText: useAnimatedStyle(() => {
            const opacity = interpolate(
                translateY.value,
                [-(BUTTON_HEIGHT - SWIPEABLE_AREA), 0],
                [-1, 1],
                Extrapolation.CLAMP
            );
            return {
        ...
        <GestureDetector gesture={slideButtonGesture}>
            ...
            >
                <View style={styles.arrows}>
                    <FontAwesome name="chevron-up" size={24} color={"rgba(255, 255, 255, 0.3)"} />
                    <FontAwesome name="chevron-up" size={24} color={"rgba(255, 255, 255, 1)"} />
                </View>
